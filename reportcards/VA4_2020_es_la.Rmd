...
filenames = list.files(here("../CD_Dirs/VA4"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("../CD_Dirs/VA4", i)))
}
...
##### El 4$^\circ$ distrito de Virginia; asiento ocupado por `r VA4[1,2]` desde `r VA4[1,8]` 
 <div class="container">
  <img src="../CD_maps/VA4_map.png" alt="Snow" style="width:100%;">
   <div class="bottom-left">El mapa demuestra el Distrito Congruesal o Estado con grupos de instalaciones reguladas</div>
  </div>
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="VA4", "VA4", "otros CDs/\nestados")
...
VA4_dot <- CWAper1000[which(CWAper1000$CD.State=="VA4"), ]
...
ggsave("dotplot_VA4.png", dotplot, path=here("../CD_Dirs/VA4"), scale = 2, width=9, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/VA4/dotplot_VA4.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>En VA4, hubo <span style="color:#569b5e">`r VA4_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_VA-4`
...
enforcementfinegraph <- enforcement %>% ggplot()+
  ...
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="Multas ($1,000’s)", x="Año", caption="Estos valores han sido ajustados para tomar en cuenta la inflación, tenga en cuenta que el eje-y informa valores en 1000’s. Un valor de $2,000 representa $2,000,000 (2 millones de dólares).", title="Multas por violaciones-CAA, CWA, RCRA\n", subtitle="Datos potencialmente incompletos")+
...
```
# ASPECTOS DESTACADOS DEL 4$^\circ$ DISTRITO DE VIRGINIA
...
names(`inspectionsper1000_All_pg4_VA-091820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_VA-091820.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_VA-091820.csv`, `inspectionsper1000_All_pg4_VA-4`)
...
inspect1000bar <- ggplot(inspectionsper1000, aes(fill=Region, y=Inspectionsper1000, x=Program, alpha=Program))+
  ...
  labs(y="Inspecciones por cada 1000 Instalaciones\n", x="")+
...
names(`violationsper1000_All_pg4_VA-091820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_VA-091820.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_VA-091820.csv`, `violationsper1000_All_pg4_VA-4`)
...
violations1000bar <- ggplot(violationsper1000, aes(fill=Region, y=violationsper1000, x=Program, alpha=Program))+
  ...
  labs(y="Violaciones por cada 1000 Instalaciones", x="")+
...
Para acceder el Jupyter notebook que extrae datos de ECHO a nivel estatal y al nivel del Distrito Congresual, haga clic [aquí](https://colab.research.google.com/drive/1mc6Gh_NAoF8y9ky7_mPeWoysn8dX7v7k#scrollTo=HKVeAQJ3kcjs). Para obtener datos nacionales, haga clic [aquí](https://colab.research.google.com/drive/1UlN_imeMhe7iX64SI0TFrczghz2tFEb6#scrollTo=sS8mFCHP7IpV).
...
if ( nrows_caa > 0 ) {
  ...
  if ( nrows_caa == 1 ) {
    ...
    CAAfacilities <- CAAbadactors %>%
      ...
      coord_flip()
    ggsave("CAAfacilities.png", CAAfacilities, path=here("../CD_Dirs/VA4"), scale = 3, width=7, height=4, units=c("cm"))
  }
}
...
ggsave("CWAfacilities.png", CWAfacilities, path=here("../CD_Dirs/VA4"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("../CD_Dirs/VA4"), scale = 3, width=7, height=4, units=c("cm"))

```
`r if ( nrow( CAAbadactors ) == 0) { 
    "<br /><br />### No consistent violators of the Clean Air Act are reported in ECHO"
  } else {
    "<a ><img src=\"../CD_Dirs/VA4/CAAfacilities.png\" style=\"float: left; width: 65%; height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO para estas instalaciones:**</font><font size=\"1.5\">"
  }`
...
<a ><img src="../CD_Dirs/VA4/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>

<font size="3">**Informes de ECHO para estas instalaciones:**</font>

<font size="1.5">[`r na.omit(CWAbadactors[1,8]) `](`r na.omit(CWAbadactors[1,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[2,8]) `](`r na.omit(CWAbadactors[2,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[3,8]) `](`r na.omit(CWAbadactors[3,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[4,8]) `](`r na.omit(CWAbadactors[4,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[5,8]) `](`r na.omit(CWAbadactors[5,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[6,8]) `](`r na.omit(CWAbadactors[6,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[7,8]) `](`r na.omit(CWAbadactors[7,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[8,8]) `](`r na.omit(CWAbadactors[8,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[9,8]) `](`r na.omit(CWAbadactors[9,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(CWAbadactors[10,8]) `](`r na.omit(CWAbadactors[10,5]) `)</font>
<br />
<br />

<a ><img src="../CD_Dirs/VA4/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>

<font size="3">**Informes de ECHO para estas instalaciones:**</font>

<font size="1.5">[`r na.omit(RCRAbadactors[1,8]) `](`r na.omit(RCRAbadactors[1,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[2,8]) `](`r na.omit(RCRAbadactors[2,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[3,8]) `](`r na.omit(RCRAbadactors[3,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[4,8]) `](`r na.omit(RCRAbadactors[4,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[5,8]) `](`r na.omit(RCRAbadactors[5,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[6,8]) `](`r na.omit(RCRAbadactors[6,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[7,8]) `](`r na.omit(RCRAbadactors[7,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[8,8]) `](`r na.omit(RCRAbadactors[8,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[9,8]) `](`r na.omit(RCRAbadactors[9,5]) `)</font>
<br />
<font size="1.5">[`r na.omit(RCRAbadactors[10,8]) `](`r na.omit(RCRAbadactors[10,5]) `)</font>
<br />
...
vCAAgraph <- ggplot(CAAviolations, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  ...
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Violaciones", x="Año", title="Violaciones de CAA\n", subtitle ="Datos mayormente completos")+
...
iCAAgraph <- ggplot(CAAinspections, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Inspecciones", x="Año", title="Inspecciones de CAA\n", subtitle ="Datos potencialmente incompletos")+
...
eCAAgraph <- ggplot(CAAenforcement, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y=" # de Acciones", x="Año", title="Acciones de aplicación de CAA\n", subtitle ="Datos potencialmente incompletos")+
  scale_y_continuous(expand=c(0,0), limits=c(0,max(CAAviolations$Count+(.2*max(CAAviolations$Count)))))+
  scale_x_discrete(breaks=c(2004,2008,2012, 2016, 2019))+
  geom_text(aes(label=Count, family="Georgia", fontface="bold"), position = position_dodge(0.9), vjust = -0.1, size=3)+
  theme_meg()+
...
fineCAAgraph <- ggplot(CAAenforcement, mapping=aes(x=factor(Date), y=Amountinthousands, fill=President, group=1))+
  ...
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Multas ($1,000)", x="Año", title="Multas de CAA\n", subtitle ="Datos potencialmente incompletos", caption="Estos valores han sido ajustados para tomar en cuenta la inflación, tenga en cuenta que el eje-y informa valores en 1000’s. Un valor de $2,000 representa $2,000,000 (2 millones de dólares).")+
...
vCWAgraph <- ggplot(CWAviolations, mapping=aes(x=factor(YEAR), y=Count, fill=President, group=1))+
  ...
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y=" # de Violaciones", x="Año", title="Violaciones de CWA\n", subtitle ="Datos mayormente completos")+
...
iCWAgraph <- ggplot(CWAinspections, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Inspecciones", x="Año", title="Inspecciones de CWA\n", subtitle ="Datos potencialmente incompletos")+
...
eCWAgraph <- ggplot(CWAenforcement, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Acciones", x="Año", title="Acciones de aplicación de CWA\n", subtitle="Datos potencialmente incompletos")+
...
fineCWAgraph <- ggplot(CWAenforcement, mapping=aes(x=factor(Date), y=Amountinthousands, fill=President, group=1))+
  geom_bar(stat="identity", alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Multas ($1,000)", x="Año", title="Multas de CWA\n", subtitle="Potentially incomplete data", caption="Estos valores han sido ajustados para tomar en cuenta la inflación, tenga en cuenta que el eje-y informa valores en 1000’s. Un valor de $2,000 representa $2,000,000 (2 millones de dólares).")+
...
vRCRAgraph <- ggplot(RCRAviolations, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.3)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Violaciones", x="Año", title = "Violaciones de RCRA\n", subtitle = "Datos muy incompletos")+
...
iRCRAgraph <- ggplot(RCRAinspections, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Inspecciones", x="Año", title="Inspecciones de RCRA\n", subtitle="Datos potencialmente incompletos")+
...
eRCRAgraph <- ggplot(RCRAenforcement, mapping=aes(x=factor(Date), y=Count, fill=President, group=1))+
  geom_bar(stat="identity", show.legend = FALSE, alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Acciones", x="Año", title="Acciones de aplicación de RCRA\n", subtitle = "Datos potencialmente incompletos")+
  scale_y_continuous(expand=c(0,0), limits=c(0,max(RCRAviolations$Count+(.2*max(RCRAviolations$Count)))))+
  scale_x_discrete(breaks=c(2004,2008,2012, 2016, 2019))+
  geom_text(aes(label=Count, family="Georgia", fontface="bold"), position = position_dodge(0.9), vjust = -0.1, size=3)+
  theme_meg()+
...
fineRCRAgraph <- ggplot(RCRAenforcement, mapping=aes(x=factor(Date), y=Amountinthousands, fill=President, group=1))+
  geom_bar(stat="identity", alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Multas ($1,000)", x="Año", title="Multas de RCRA\n", subtitle = "Datos potencialmente incompletos", caption="Estos valores han sido ajustados para tomar en cuenta la inflación, tenga en cuenta que el eje-y informa valores en 1000’s. Un valor de $2,000 representa $2,000,000 (2 millones de dólares).")+
...
<br />
<a ><img src="../CD_images/VA4_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r VA4[1,2]`](`r VA4[1,9]`) (`r VA4[1,3]`)</h2>

## Ha estado en esta oficina `r VA4[1,6]` `r VA4[1,7]`, `r VA4[1,8]`

## Membresía del Comité Relevante:  [Comité de Energía y Comercio](https://energycommerce.house.gov/)
<br /> 
<br />
<div class="text-box-info">
### El Comité de Energía y Comercio de la Cámara
Este Comité es el Comité de la Cámara de Los Estados Unidos más antiguo con la jurisdicción más extensiva de cualquier otro comité autorizador. El Comité supervisa la EPA y legisla leyes sobre temas sobre la protección ambiental, aire limpio, cambio climático, agua potable segura, químicos tóxicos y desechos peligrosos e instalaciones nucleares. Actualmente, el Comité tiene 55 miembros: 24 republicanos y 31 demócratas.
</div>
...
<h4><span style="padding-left:30px">[`r VA4[1,10]`](`r VA4[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r VA4[1,12]`](`r VA4[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r VA4[1,14]`](`r VA4[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r VA4[1,16]`](`r VA4[1,17]`)</span></h4>
...
* Aunque no hay información específica sobre la calidad de los datos sobre las violaciones de RCRA, es probable que este programa, como la CAA, tenga serios problemas de reportación. Por lo tanto, los datos de violaciones de RCRA también deben considerarse inexactos y potencialmente engañosos. La mayor diferencia clave entre la RCRA y la CWA es que la CWA requiere autoinforme electrónico obligatorio. 
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/VA4_2020.pdf)

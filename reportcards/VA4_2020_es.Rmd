...
enforcementfinegraph <- enforcement %>% ggplot()+
  ...
  theme_meg()+
  theme(axis.text.x=element_text(size=9),
        axis.title.x = element_blank(), plot.subtitle = element_text(hjust=.5, size=9), plot.caption = element_text(size=10, hjust=.5), plot.title = 
          element_text(lineheight = .1, size=10))
  ...
  if ( nrows_caa == 1 ) {
     CAAfacilities <- CAAbadactors %>%
      ...
      theme(axis.text.y=element_text(size=12, face = "bold", color="black"), axis.title.x = element_text(size=14), axis.text.x=
              element_text(size=14,face = "bold"), plot.title=element_text(size=16), plot.margin = unit(c(1,1,1,1),"cm"))+
      coord_flip()
    ...
    CAAfacilities <- CAAbadactors %>%
      ...
      scale_x_discrete(expand=c(0,0))+
      theme(axis.text.y=element_text(size=12, face = "bold", color="black"), axis.title.x = element_text(size=14), axis.text.x=element_text(size=14,face = "bold"), plot.title=element_text(size=16), plot.margin = unit(c(1,1,1,1),"cm"))+
      coord_flip()
  }
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/VA4/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/VA4/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/VA4/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
fineCAAgraph <- ggplot(CAAenforcement, mapping=aes(x=factor(Date), y=Amountinthousands, fill=President, group=1))+
  ...
  theme_meg()+
  theme(axis.text.x=element_text(size=10),
        axis.title.x = element_blank(), plot.subtitle = element_text(hjust=.5), plot.caption = element_text(size=10, hjust=.5))
...
fineCWAgraph <- ggplot(CWAenforcement, mapping=aes(x=factor(Date), y=Amountinthousands, fill=President, group=1))+
  geom_bar(stat="identity", alpha=.6)+
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y="# de Multas ($1,000)", x="Año", title="Multas de CWA\n", subtitle="Potentially incomplete data", caption=common_caption)+
